...
def opener_prompt(
    ...
    *,
    ...
    return (
        ...
        f"Greet in YOUR voice: 1–3 short sentences or two tight paragraphs max. "
    ...
    *,
    ...
    if reply_to_name and reply_to_idea:
        ...
        return (
            ...
            f"Reply TO them as {who} — short, funny, original. Don't copy wording. "
            f"Camp: {ctx}.{near_bit}"
        )
    return (
        f"You are {who} at camp. Notice one real thing (fire, music, pond, {visitor}, props) "
        f"and riff 1–3 short paragraphs — funny, specific, YOUR voice. Camp: {ctx}.{near_bit}"
    )
